...
import com.reffueld.client.auth.Authentication;
import com.reffueld.client.auth.HttpBasicAuth;
import com.reffueld.client.auth.ApiKeyAuth;
import com.reffueld.client.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://reffueld.com/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("apiKeySecurity", new ApiKeyAuth("header", "X-REFFUELD-APIKEY"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://reffueld.com/api/v1
